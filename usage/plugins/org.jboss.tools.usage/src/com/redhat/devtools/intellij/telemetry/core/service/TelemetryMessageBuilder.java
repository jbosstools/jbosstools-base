...
public class TelemetryMessageBuilder {
    ...
    public TelemetryMessageBuilder() {
    ...
    private abstract static class Message<T extends Message<?>> {
        ...
        public T property(String key, String value) {
            if (key == null
                    || value == null) {
            	JBossToolsUsageActivator.getDefault().getLogger().warn("Ignored property with key: " + key + " value: " + value, null);
            } else {
    ...
    static class ServiceFacade {
        ...
        protected ITelemetryService createService() {
            return new TelemetryServiceFactory().create();
        }
