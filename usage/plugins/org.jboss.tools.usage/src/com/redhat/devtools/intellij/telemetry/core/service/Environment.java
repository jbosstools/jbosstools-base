...
public class Environment {
    ...
    public static class Builder {
    	...
    	private IJBossToolsEclipseEnvironment eclipseEnvironment = JBossToolsUsageActivator.getDefault().getJBossToolsEclipseEnvironment();
        private IDE ide;
        ...
        private void ensureIDE() {
            if (ide == null) {
                ide(new IDE.Factory().create(eclipseEnvironment.getEclipseUserAgent()));
            }
        }

        public Buildable plugin() {
        	String name = JBossToolsUsageActivator.PLUGIN_ID;
        	String version = eclipseEnvironment.getJBossToolsVersion();
            return plugin(new Plugin.Factory().create(name, version));
        }
        ...
        private void ensurePlatform() {
            if (platform == null) {
                platform(new Platform(eclipseEnvironment.getEclipseUserAgent()));
            }
        }
