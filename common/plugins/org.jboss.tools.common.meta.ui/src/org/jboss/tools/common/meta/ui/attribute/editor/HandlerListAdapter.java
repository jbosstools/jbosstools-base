...
public class HandlerListAdapter extends DefaultComboBoxValueAdapter {

	protected IListContentProvider createListContentProvider(XAttribute attribute) {
		HandlerListContentProvider p = new HandlerListContentProvider();
		p.setModel(model);
...
class HandlerListContentProvider extends DefaultXAttributeListContentProvider {
