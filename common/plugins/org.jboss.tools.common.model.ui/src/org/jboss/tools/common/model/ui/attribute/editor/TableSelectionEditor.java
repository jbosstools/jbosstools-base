...
public class TableSelectionEditor extends SelectionEditor {

	protected DialogCellEditorEx cellEditor;
	protected TableSelectionFieldEditor fieldEditor;
	
	public TableSelectionEditor() {}

	public TableSelectionEditor(IWidgetSettings settings) {
		super(settings);
	}
	...
	protected ExtendedFieldEditor createFieldEditor(Composite parent) {
		fieldEditor = new TableSelectionFieldEditor(settings);
