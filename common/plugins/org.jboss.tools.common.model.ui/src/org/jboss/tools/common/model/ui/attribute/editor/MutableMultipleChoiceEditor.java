...
public class MutableMultipleChoiceEditor extends StructuredEditor {
	protected DialogCellEditorEx cellEditor;
	protected MutableMultipleChoiceFieldEditor fieldEditor;
	
	public MutableMultipleChoiceEditor() {}

	public MutableMultipleChoiceEditor(IWidgetSettings settings) {
		super(settings);
	}
	...
	protected ExtendedFieldEditor createFieldEditor(Composite parent) {
		fieldEditor = new MutableMultipleChoiceFieldEditor(settings);
