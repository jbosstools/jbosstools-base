...
public class FileChoicerEditor extends ValueEditor {	
	protected DialogCellEditorEx cellEditor;
	protected FileFieldEditorEx fieldEditor;
	
	public FileChoicerEditor() {}

	public FileChoicerEditor(IWidgetSettings settings) {
		super(settings);
		lineEditor = true;
	}
	...
	public Object callExternal(Shell shell) {
		this.fieldEditor = new FileFieldEditorEx(settings);
