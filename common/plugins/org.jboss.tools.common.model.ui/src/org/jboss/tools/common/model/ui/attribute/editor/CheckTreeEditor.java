...
public class CheckTreeEditor extends ValueEditor {

	protected DialogCellEditorEx cellEditor;
	protected CheckTreeFieldEditor fieldEditor;
	
	public CheckTreeEditor() {}

	public CheckTreeEditor(IWidgetSettings settings) {
		super(settings);
	}
...
//		IValueProvider valueProvider = (IValueProvider)getAdapter(IValueProvider.class);
		fieldEditor = new CheckTreeFieldEditor(settings);
